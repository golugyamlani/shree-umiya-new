                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl space-y-20">
                    ...
                    <div className="bg-white rounded-sm shadow-xl border border-gray-100 overflow-hidden flex flex-col md:flex-row">
                        <div className="w-full md:w-5/12 relative">
                            ...
                            <img src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?q=80&w=800&auto=format&fit=crop" alt="Warehouse facility" className="w-full h-full object-cover min-h-[300px]" />
                        </div>
                    ...
                    <div className="bg-white rounded-sm shadow-xl border border-gray-100 overflow-hidden flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-5/12 relative order-1 md:order-2">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?q=80&w=800&auto=format&fit=crop" alt="Quality inspection" className="w-full h-full object-cover min-h-[300px]" />
                        </div>
                    </div>
