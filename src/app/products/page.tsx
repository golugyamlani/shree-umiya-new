...
const PRODUCTS = [
    { id: 1, name: "Premium White Duvet Cover", category: "Hotel Linen & Bedding", moq: "50 Pieces", spec: "300 TC Cotton, Commercial Grade. Designed for high-cycle industrial laundering. Features a hidden zipper closure and internal corner ties to secure the duvet insert.", price: "Bulk pricing available on request", image: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?q=80&w=800&auto=format&fit=crop" },
